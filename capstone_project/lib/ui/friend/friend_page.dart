...
class _FriendPageState extends State<FriendPage> {
  ...
  late CheckFriendRequestModel checkRequestModel =
      CheckFriendRequestModel(uID1: UserData.uid.toString(), friendAccount: "");
  late InviteFriendRequestModel inviteRequestModel = InviteFriendRequestModel(
      uID1: UserData.uid.toString(), friendAccount: "");
  ...
  Future<List<Map<String, dynamic>>?> getFriendList() async {
    ...
    await apiService
        .selectFriend(SelectFriendRequestModel(uID1: UserData.uid.toString()));
                  ...
                  (value) {
                    if (value) {
                      ...
                      SqliteHelper.delete(
                          tableName: "friend",
                          tableIdName: "uID",
                          deleteId: int.parse(delRequestModel.uID2));
            ...
            TextButton(
              ...
              onPressed: () {
                ...
                apiService.checkFriend(checkRequestModel).then((value) {
                  if (value) {
                    inviteRequestModel.friendAccount =
                        checkRequestModel.friendAccount;
