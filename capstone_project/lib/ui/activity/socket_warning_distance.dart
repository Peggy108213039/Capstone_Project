...
class SocketWarningDistance extends StatefulWidget {
  final bool isStarted;
  final bool isPaused;
  final Object? socketMssege;
  const SocketWarningDistance(
      {Key? key,
  ...
  @override
  State<SocketWarningDistance> createState() => _SocketWarningDistanceState();
}

class _SocketWarningDistanceState extends State<SocketWarningDistance> {
  late bool isStarted;
  late bool isPaused;
